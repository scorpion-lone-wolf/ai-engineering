...
**Scope boundary:** authentication, authorization, permissions, security, logging, rate limiting, and deployment here are taught only to the depth required to build a safe MCP service. Full AI-security/guardrail engineering remains Phase 16; full cloud/deployment engineering remains Phase 20.
